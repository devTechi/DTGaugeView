#
#  Be sure to run `pod spec lint DTGaugeView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   A longer description of DTGaugeView in Markdown format.
  ...
  s.homepage     = "https://github.com/devTechi/DTGaugeView"
  ...
  s.source_files  = "DTGaugeView", "DTGaugeView/**/*.{h,m}"
